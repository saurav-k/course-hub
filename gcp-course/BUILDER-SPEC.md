# BUILDER-SPEC - Inside Google Cloud
...
- Course name in chrome: **INSIDE GOOGLE CLOUD**; footer prefix "Inside Google Cloud".
- Canon is https://cloud.google.com/docs; anything else is labelled third-party at the point of use.

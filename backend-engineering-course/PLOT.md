...
Modules 05 and 08-12 above are all reserved from the first scaffold, mapped to the upstream chapters. Each
...
Modules 05 and 08 to 12 will develop - a transaction, a cache, a graceful shutdown - and links forward

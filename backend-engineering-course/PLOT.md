...
| 12 | Module 12 - Inter-service communication (1200-1205) | written | Three couplings and how to choose between them, gRPC and its deadline, the queue, the log, and the WebSocket. Written while Modules 05 and 07 to 11 stay reserved, because nothing in it depends on them. |
...
Module 12 landed sixth, after Module 03, because it needs only the vocabulary of Modules 02, 04 and 06:

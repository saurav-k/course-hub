# 0087 - A long chain of Jacobians: what backprop costs, and how the signal decays
...
1. **Orientation, `flowchart LR`.** "Backpropagation works (0086)" into "THIS PAGE: what

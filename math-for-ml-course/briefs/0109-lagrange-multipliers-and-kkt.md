...
**Page `lessons/0109-lagrange-multipliers-and-kkt.html`** &middot; module M06, lesson 10 of 12 &middot; program `code/0109-lagrange-multipliers-and-kkt.py` &middot; dataset `datasets/m06-credit.csv`

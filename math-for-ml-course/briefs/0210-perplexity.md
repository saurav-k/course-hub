...
0200 (entropy), 0201 (cross-entropy). Nothing else; this page is deliberately the easy landing
...
2. **Orientation figure.** 0201's cross-entropy in bits into "this page: exponentiate to get a
   count of options" into reading a scaling-law plot, with 0200 dotted in as the floor.
...
`code/0210-perplexity.py` against `m10_classifier.csv` read as a next-symbol predictor. Computes

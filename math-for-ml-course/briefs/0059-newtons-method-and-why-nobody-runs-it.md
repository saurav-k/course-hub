...
**Page `lessons/0059-newtons-method-and-why-nobody-runs-it.html`** &middot; module M06, lesson 8 of 12 &middot; program `code/0059-newtons-method-and-why-nobody-runs-it.py` &middot; dataset `datasets/m06-credit.csv`

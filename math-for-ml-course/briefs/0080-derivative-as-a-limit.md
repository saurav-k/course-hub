# 0080 - A derivative is the exchange rate between a small input change and a small output change
...
| Enables | 0081 (chain rule), and every page after it |
...
7. **Close by naming the debt.** Real models are compositions. 0081 pays it.
...
and not differentiable there. That witness is 0082's whole page, so name it and move on.

## Figures

1. **Orientation, `flowchart LR`.** "A function you can evaluate (M01)" into
   "THIS PAGE: how fast it changes" into "the chain rule (0081)" and "every gradient

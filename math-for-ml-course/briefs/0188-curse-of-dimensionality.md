# 0188 - The curse of dimensionality
...
0185 (distances). 0186 (what an embedding space actually looks like). M03 for norms. **M08 owns
...
2. **Orientation figure.** 0185's three distance functions into "this page: what happens to all of
   them as `d` grows" into 0187 (which adds dimensions on purpose) and 0186 (which searches in
...
`code/0188-curse-of-dimensionality.py` against `m10_embeddings.csv` plus generated points. Evaluates

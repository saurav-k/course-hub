...
0180 (entropy), 0181 (cross-entropy). Nothing else; this page is deliberately the easy landing
...
2. **Orientation figure.** 0181's cross-entropy in bits into "this page: exponentiate to get a
   count of options" into reading a scaling-law plot, with 0180 dotted in as the floor.
...
`code/0190-perplexity.py` against `m10_classifier.csv` read as a next-symbol predictor. Computes

...
**Page `lessons/0110-regularization-is-a-constraint-you-can-draw.html`** &middot; module M06, lesson 11 of 12 &middot; program `code/0110-regularization-is-a-constraint-you-can-draw.py` &middot; dataset `datasets/m06-credit.csv`

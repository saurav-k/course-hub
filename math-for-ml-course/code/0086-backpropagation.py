"""Lesson 0086 - backpropagation is the chain rule on a computation graph.
...
The network is a 4-32-1 regressor on the housing table. Rows are samples.
    ...
    python3 0086-backpropagation.py
"""
...
def training_arrays() -> tuple[np.ndarray, np.ndarray]:
    ...
    Lesson 0089 is where the scaling itself gets explained.
    """
    frame = load()

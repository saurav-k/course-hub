...
Lectures 1 to 8, TA Sessions 1 and 2, and Homework 1 are on the site, occupying lessons `0000` to `0119`; see [`PLOT.md`](PLOT.md) for the exact state and the true reading order.

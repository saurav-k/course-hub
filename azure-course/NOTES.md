...
Terms Azure gives its own names get defined at first use and reused exactly after;
...
- Every lesson registers as a card in `index.html` and in the generated
  `outline.js`; `python3 scripts/gen_outline.py azure-course` after adding one.

...
- Course name in chrome: **INSIDE AZURE**; footer prefix "Inside Azure".
- Canon is https://learn.microsoft.com/en-us/azure/; anything else is labelled third-party at the point of use.
